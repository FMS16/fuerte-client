                    ...
                    <div className="ticker">
                        <div className="ticker-inner">
                            <div className="ticker-item">
                                <p className='size-small'>¡Hola preciosa! Te regalamos 10% de descuento usando el código <span className='bold'>MOTIVACIÓN</span> para celebrar juntas nuestro lanzamiento 🎉</p>
                            </div>
                            <div className="ticker-item">
                                <p className='size-small'>¡Hola preciosa! Te regalamos 10% de descuento usando el código <span className='bold'>MOTIVACIÓN</span> para celebrar juntas nuestro lanzamiento 🎉</p>
                            </div>
            ...
            {isMobileOrTablet ? (
                <div className='header-main'>
                    <div className='header-menu-nav header-mobile-nav'>
                        <button onClick={toggleMenu} className='fa-bars'>
                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M14 5H2V3h12v2zm0 4H2V7h12v2zM2 13h12v-2H2v2z"></path>
                            </svg>
                        </button>
                        <button>
                            <Link href='/wishlist'><svg strokeWidth="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {navVisible && (
                            <motion.nav
                                ...
                                <ul>
                                    ...
                                    <li><Link onClick={toggleMenu} href='/contact'>Contacto <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.146 4.646a.5.5 0 01.708 0l3 3a.5.5 0 010 .708l-3 3a.5.5 0 01-.708-.708L12.793 8l-2.647-2.646a.5.5 0 010-.708z" clipRule="evenodd"></path><path fillRule="evenodd" d="M2 8a.5.5 0 01.5-.5H13a.5.5 0 010 1H2.5A.5.5 0 012 8z" clipRule="evenodd"></path></svg></Link></li>
                ...
                <div className='header-main'>
                    <div className='header-logo'>
                        <Link href="/" className='relative'><Image src={logo2} alt='logo' fill /></Link>
                    </div>
