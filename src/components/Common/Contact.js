...
import image from "../../assets/images/bannerDos.jpg"
        ...
        <>
          <div className='container d-flex'>
            <div className='contact-item relative'>
              <Image src={image} fill={true} alt='imagen contacto' />
            </div>
            <div className='contact-item'>
              <div className='contact-subitem contact-faqs'>
                <h1>Preguntas frecuentes</h1>
