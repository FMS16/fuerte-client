            ...
            <div className='footer-container'>
                ...
                <div className='footer-item footer-links c-flex'>
                    ...
                    <div className={`footer-social-media`}>
                        {!isMobileOrTablet && (<h1 className='footer-list-title'>Contacto</h1>)}
                        <a href=''>
                            ...
                            {!isMobileOrTablet ? ('+598 98 309 390') : null}
                        </a>
                        <a href=''>
                            ...
                            {!isMobileOrTablet ? ('@fuerte.active') : null}
                        </a>
                        <a href=''>
                        ...
                        <a href=''>
                            ...
                            {!isMobileOrTablet ? ('hola@fuerte.com.uy') : null}
                        </a>
                    </div>
                </div>
            </div>
