...
const CheckoutUserDetails = ({ onNextStep, updateData, userDetails }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (localUserDetails.name == '' && localUserDetails.lastName == '' && localUserDetails.phone == '' && localUserDetails.email == '') {
    ...
    return (
        <div className='checkout-user-details'>
            <h1 className='checkout-title'>Contacto <Link href='/login'>Iniciar sesi&oacute;n</Link></h1>
